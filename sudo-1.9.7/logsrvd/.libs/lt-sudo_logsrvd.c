...
/* ./.libs/lt-sudo_logsrvd.c - temporary wrapper executable for .libs/sudo_logsrvd
   Generated by libtool (GNU libtool) 2.4.6

   The sudo_logsrvd program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "sudo_logsrvd"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# sudo_logsrvd - temporary wrapper script for .libs/sudo_logsrvd\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6\n", f);
  fputs ("#\n", f);
  fputs ("# The sudo_logsrvd program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"sudo_logsrvd:sudo_logsrvd:$LINENO: libtool wrapper (GNU libtool) 2.4.", f);
  fputs ("6\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"sudo_logsrvd:sudo_logsrvd:$LINENO: newargv[$lt_dump_args_N]: $lt_arg", f);
  fputs ("\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"sudo_logsrvd:sudo_logsrvd:$LINENO: newargv[0]: $progdir/$program", f);
  fputs ("\" 1>&2\n", f);
