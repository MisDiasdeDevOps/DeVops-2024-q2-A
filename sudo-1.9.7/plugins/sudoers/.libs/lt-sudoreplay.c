...
/* ./.libs/lt-sudoreplay.c - temporary wrapper executable for .libs/sudoreplay
   Generated by libtool (GNU libtool) 2.4.6

   The sudoreplay program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "sudoreplay"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# sudoreplay - temporary wrapper script for .libs/sudoreplay\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6\n", f);
  fputs ("#\n", f);
  fputs ("# The sudoreplay program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"sudoreplay:sudoreplay:$LINENO: libtool wrapper (GNU libtool) 2.4.6\" 1", f);
  fputs (">&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"sudoreplay:sudoreplay:$LINENO: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"sudoreplay:sudoreplay:$LINENO: newargv[0]: $progdir/$program\" 1>", f);
  fputs ("&2\n", f);
